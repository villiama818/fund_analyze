...
| 2026-05-27 | v2.7 | 图表网格线、tooltip 深浅色主题自动适配 |
| 2026-05-27 | v2.8 | 修复主题切换按钮，让图表颜色同步更新 |
| 2026-05-27 | v2.9 | 用 getChartGridColor() 函数替代静态变量，主题切换动态生效 |
| 2026-05-27 | v2.10 | 修复主题切换逻辑，用显式 dark/light class 替代 toggle |
| 2026-05-27 | v2.11 | 修复：dark/light CSS 变量完全覆盖，不依赖 :root 默认值 |